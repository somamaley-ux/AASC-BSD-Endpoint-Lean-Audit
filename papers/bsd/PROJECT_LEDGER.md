# Project ledger - BSD Endpoint Closure, final pre-Lean freeze
...
6. ATS/UEAP classify endpoint-resolving mismatch as tensor endpoint governance.
7. Endpoint governance is independent rank discrimination after legitimate roles are exhausted.
